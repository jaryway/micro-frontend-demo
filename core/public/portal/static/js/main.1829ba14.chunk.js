window["portal"] =
(window["JsonpPortal"] = window["JsonpPortal"] || []).push([[0],[
/* 0 */
...
var publicUrl=new URL("/portal",window.location.href);if(publicUrl.origin!==window.location.origin){// Our service worker won't work if PUBLIC_URL is on a different origin
// from what our page is served on. This might happen if a CDN is used to
// serve assets; see https://github.com/facebook/create-react-app/issues/2374
return;}window.addEventListener('load',function(){var swUrl="".concat("/portal","/service-worker.js");if(isLocalhost){// This is running on localhost. Let's check if a service worker still exists or not.
...
var root_component_RootComponent=/*#__PURE__*/function(_React$Component){_inherits(RootComponent,_React$Component);function RootComponent(){_classCallCheck(this,RootComponent);return _possibleConstructorReturn(this,_getPrototypeOf(RootComponent).apply(this,arguments));}_createClass(RootComponent,[{key:"render",value:function render(){return external_React_default.a.createElement("div",{className:"portal"},"Wo! This is portal site");}}]);return RootComponent;}(external_React_default.a.Component);/* harmony default export */ var root_component = (root_component_RootComponent);
