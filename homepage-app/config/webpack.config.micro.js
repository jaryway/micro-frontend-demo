...
module.exports = function (webpackEnv) {
  ...
  const publicUrl = isEnvProduction
    ...
    : isEnvDevelopment && (isMicro ? publicPath.slice(0, -1) : '');
  ...
  return {
    ...
    output: {
      ...
      // 微前端时以 amd 打包
      libraryTarget: isMicro ? 'amd' : undefined,
    },
    optimization: {
      ...
      isMicro
        ...
        : new HtmlWebpackPlugin(
            Object.assign(
              {},
              isMicro
                ? { inject: false, template: paths.appTemplate, chunks: ['main'] }
                : { inject: true, template: paths.appHtml, chunks: ['main'] },
              isEnvProduction
                ? {
                    minify: {
                      removeComments: true,
